<template>
	<view class="caigou_index">
		...
		<w-picker :visible.sync="dateVisible1" mode="date" startYear="2017" endYear="2029" :current="false" fields="day" :value="time"
	...
	export default {
		...
		methods: {
			requestBuyerList() {
				...
				rs.getRequests("buyerList", data, (res) => {
