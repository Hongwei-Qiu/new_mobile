<template>
	<view class="caigou_index">
		...
		<uni-nav-bar left-icon="back" title="退货单" :status-bar="navBar" color="black" @clickLeft="goPage"></uni-nav-bar>
		...
		<view class="head">
			...
			<!-- <view  class="heightScroll"></view> -->
			<view style="height: calc(44px + 92rpx);"></view>
...
<style>
	...
	.caigou_index .show_bitmap{padding-top:21%;}
