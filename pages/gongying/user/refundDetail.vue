<template>
	<view class="detail">
		<uni-nav-bar left-icon="back" :statu-bar="navBar"  title="退货单详情" color="#1A1A1A" @clickLeft="goPage"></uni-nav-bar>
	...
	export default {
		...
		methods: {
         ...
         returnDetail(){
			 ...
			 rs.getRequests("supplierPurchaseReturnsDetail", data, (res) => {
