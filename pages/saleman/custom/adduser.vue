...
<view style="height: 49px;"></view>
			...
			<form @submit="save">
				<view class="user_info">
					<view>
						<view>单位名称</view>
						<view>
							<input type="text"  placeholder="请输入单位名称" placeholder-class="place_style" name="nickname">
							<text></text>
						</view>
					</view>
					<view>
						<view>用户手机</view>
						<view>
							<input type="number"  placeholder="请输入手机号码" placeholder-class="place_style" name="mobile">
							<text></text>
						</view>
					</view>
					<view>
						<view>用户密码</view>
						<view>
							<input password="true"  placeholder="请输入6位(含)以上" placeholder-class="place_style"
							 name="password">
							<text></text>
						</view>
					</view>
					<view>
						<view>用户分组</view>
						<view>
							<input type="text"  v-model="group_title" placeholder="请选择分组" disabled placeholder-class="place_style"
							 name="group">
					...
					<view>
						<view>用户区域</view>
						<view>
							<input type="text" v-model="region_title" placeholder="请选择区域" disabled placeholder-class="place_style"
							 name="area">
					...
					<view>
						<view>用户编码</view>
						<view>
							<input type="text"  placeholder="输入用户编码" placeholder-class="place_style" name="code">
							<text></text>
						</view>
					</view>
					<view>
						<view>信用金</view>
						<view>
							<input type="number"  placeholder="请输入信用金(元)" placeholder-class="place_style" name="credit">
							<text></text>
						</view>
					</view>
					<view>
					...
					<view>
						<view>收货人</view>
						<view>
							<input type="text"  placeholder="请输入收货人姓名" placeholder-class="place_style" name="contact">
							<text></text>
						</view>
					</view>
					<view>
						<view>收货手机</view>
						<view>
							<input type="number"  placeholder="请输入收货人手机号" placeholder-class="place_style" name="takePhone">
							<text></text>
						</view>
					</view>
					<view>
						<view>详细地址</view>
						<view>
							<input type="text"  style="width: 100%;" placeholder="请输入详情地址信息" placeholder-class="place_style"
							 name="address">
							<text></text>
						</view>
					</view>
		...
		<w-picker :visible.sync="showGroup" mode="selector"  default-type="name" :default-props="groupProps"
	...
	export default {
		...
		methods: {
			confirmArea(e) {
				...
				this.region_title = e.result;
			},
			confirmGroup(e) {
				console.log(e)
				this.group_id = e.value;
				this.group_title = e.result;
			},
			goPage() {
				// #ifdef H5
			...
			save(e) {
				...
				rs.postRequests("salesmanMemberCreate", data, (res) => {
					let {
						code
					} = res.data;
					if (code == 200) {
