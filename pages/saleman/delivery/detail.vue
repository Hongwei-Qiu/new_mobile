<template>
	<view class="detail">
		<uni-nav-bar left-icon="back" :right-text="rightText"  :status-bar="navBar" @clickRight="determineGood"
		 title="配送单详情" :rightColor="rightColor" @clickLeft="goPage"></uni-nav-bar>
			...
			<view class="top_box">
				...
				<view class="content">
					...
					<view class="">
						...
						<text class="iconfont icondianhua1" style="color:#04AA8E;margin-left:24rpx;" @click="callPhone(listDetail.mobile)"></text>
					</view>
				...
				uni.showModal({
					...
					success: function(res) {
						if (res.confirm) {
							...
							rs.getRequests("salesmanModifyOrderStatus", data, (res) => {
