	...
	<view class="caigou_index">
		<view class="index">
			<view class="top flex_column">
				...
				<view class="pop">
					<cmd-progress type="circle" :percent="buyerIndex.finsh" :width="150" :stroke-width="7" stroke-color="#EBF8FB"></cmd-progress>
				</view>
				<view class="number_box">
					<view class="number flex flex_align_center">
						<view class="left">
							未下单 {{buyerIndex.unfinsh}}
						</view>
						<view class="right">
							全部 {{buyerIndex.total}}
						</view>
			...
			<view class="list_box">
				<view class="item flex flex_align_center flex_between">
					...
					<view class="right">{{buyerIndex.today_price}}</view>
				</view>
				<view class="item flex flex_align_center flex_between">
					<view class="left">
						<view class="title">
					...
					<view class="right">{{buyerIndex.today_member}}</view>
				</view>
				<view class="item flex flex_align_center flex_between">
					<view class="left">
						<view class="title">
					...
					<view class="right">{{buyerIndex.unReview}}</view>
				</view>
				<view class="item flex flex_align_center flex_between">
					<view class="left">
						<view class="title">
					...
					<view class="right">{{buyerIndex.month_price}}</view>
				</view>
			</view>
	...
	export default {
		...
		methods: {
			requestIndex() {
				...
				rs.getRequests("salesmanIndex", data, (res) => {
